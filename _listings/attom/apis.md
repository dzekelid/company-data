...
apis:
- name: ' = Returns POIs based on point.'
...
- name: ATTOM
  ...
  description: 'Search public property records including real estate data: sale, ownership,
    ...
    contains tax, deed, mortgage, foreclosure, environmental risk, natural hazard,
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/company-data/master/_listings/attom/openapi.md
x-common:
- type: x-openapi
